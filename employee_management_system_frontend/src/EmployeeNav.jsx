        ...
        <div className="container-fluid gap-lg-5">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="nul navbar-nav me-auto mb-2 mb-lg-0 w-100">
              ...
              <li className="nav-item">
                <Link to="/leaveapply" className="nav-link">
                  Leaves
                </Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <div className="d-flex w-auto gap-4 justify-content-between px-4">
              <h4 className="heading fw-bolder mt-1 text-white">Welcome, {user.firstname}</h4>
